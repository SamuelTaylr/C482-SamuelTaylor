...
/**
 * Controller class that provides control logic for the Modify Part screen.
 *
 * @author Samuel Taylor
 */
public class ModifyPartController implements Initializable
{
    private Part selectedPart; //variable for part selected by user
     ...
     * methods to ensure values are valid.  Uses nested try/catch statements.
     *
    ...
    /**
     * Initializes controller and sets radio button and label
     * depending on if user selected inhouse or outsourced part.
     *
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        if (selectedPart instanceof InHouse) {
            ...
            partIdOrNameLabel.setText("Machine ID");
            partIdOrNameField.setText(String.valueOf(((InHouse)selectedPart).getMachineId()));
        }

        if (selectedPart instanceof Outsourced) {
            outsourcedRadioButton.setSelected(true);
            partIdOrNameLabel.setText("Comp. Name");
            partIdOrNameField.setText(((Outsourced)selectedPart).getCompanyName());
        }
