...
public class ModifyProductController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        this.selectedProduct = MainScreenController.getProductToModify();
        this.assocParts = this.selectedProduct.getAllAssociatedParts();
        ...
        this.assocPartTableView.setItems(this.assocParts);
        this.productIdText.setText(String.valueOf(this.selectedProduct.getId()));
        this.productNameText.setText(this.selectedProduct.getName());
        this.productInventoryText.setText(String.valueOf(this.selectedProduct.getStock()));
        this.productPriceText.setText(String.valueOf(this.selectedProduct.getPrice()));
        this.productMaxText.setText(String.valueOf(this.selectedProduct.getMax()));
        this.productMinText.setText(String.valueOf(this.selectedProduct.getMin()));
    }
}